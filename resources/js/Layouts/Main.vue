        ...
        <nav class="p-6 mx-auto max-w-screen-lg flex items-center justify-between">
            ...
            <div class="flex items-center space-x-6">
                ...
                <div v-if="user" class="relative">
                    <div @click="show = !show" class="flex items-center gap-2 px-3 py-1 rounded-lg hover:bg-slate-700
                    cursor-pointer"
                    ...
                    <!------------------ User Dropdown menu--------------->
                    <div v-show="show" @click="show = false" class="absolute z-50 top-16 right-0 bg-slate-800
                    text-white rounded-lg border-slate-50 border overflow-hidden w-40">
